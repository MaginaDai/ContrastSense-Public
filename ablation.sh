...
do
    ...
    #     python main.py -g 0 -e ${e} -lr ${lr} -tem_labels ${t} -label_type 1 -version "${version}0" -name ${dataset} --store "${store}0" -cross "users" &
    #     python main.py -g 0 -e ${e} -lr ${lr} -tem_labels ${t} -label_type 1 -version "${version}1" -name ${dataset} --store "${store}1" -cross "users" &
    #     python main.py -g 1 -e ${e} -lr ${lr} -tem_labels ${t} -label_type 1 -version "${version}2" -name ${dataset} --store "${store}2" -cross "users" &
    #     python main.py -g 1 -e ${e} -lr ${lr} -tem_labels ${t} -label_type 1 -version "${version}3" -name ${dataset} --store "${store}3" -cross "users" &
    #     python main.py -g 1 -e ${e} -lr ${lr} -tem_labels ${t} -label_type 1 -version "${version}4" -name ${dataset} --store "${store}4" -cross "users" 

    #     wait
    # done
    store_ft="emg_cdl_e2000_td${t}_v"
