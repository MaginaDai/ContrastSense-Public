...
do
    ...
    do
        ...
        python main.py -g 0 -hard True -last_ratio ${r} -time_window ${t} -lr ${lr} -slr ${slr} -label_type 0 -version "${version}2" -name ${dataset} --store "${store}2" -cross "users" &
    ...
    store_ft="emg_model_v2_hard_t${t}_"
    for dataset in "Myo" "NinaPro"
    do
