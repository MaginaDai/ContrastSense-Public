...
parser.add_argument('--mol', default='DeepSense', type=str, help='which model to use', choices=['SimCLR', 'LIMU', 'CPC', 'MoCo', 'DeepSense'])
parser.add_argument('-version', default="supervised_cross", type=str, help='control the version of the setting')
parser.add_argument('--setting', default='full', type=str, choices=['full', 'sparse'], help='decide use tune or others')
