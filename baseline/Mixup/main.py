...
parser.add_argument('-name', default='HASC', help='datasets name', choices=['HHAR', 'MotionSense', 'Shoaib', 'HASC', 'Myo', 'NinaPro', 'Merged_dataset'])
parser.add_argument('--store', default='test_HASC', type=str, help='define the name head for model storing')
