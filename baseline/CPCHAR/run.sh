...
python transfer.py -g 2 -version shot -shot 10 -name HASC --pretrained "${name}_HASC" &
python transfer.py -g 2 -version shot -shot 10 -name HHAR --pretrained "${name}_HHAR" &
python transfer.py -g 2 -version shot -shot 10 -name MotionSense --pretrained "${name}_MotionSense" &
