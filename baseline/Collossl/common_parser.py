...
def get_parser():
    ...
    parser.add_argument('-ft_version', default="shot0", type=str, help='control the version of the setting for fine-tuning')
    parser.add_argument('--store', default='lr', type=str, help='define the name head for model storing')
    parser.add_argument('--pt_store', default='lr', type=str, help='define the name head for model storing')
    parser.add_argument('-shot', default=10, type=int, help='how many shots of labels to use')
    parser.add_argument('-ft', default=False, type=bool, help='directly ft or not')

    parser.add_argument('--dataset_name', default='realworld-3.0-0.0.dat', choices=[
                        'realworld-3.0-0.0.dat', 'opportunity-1.0-0.0.dat', 'pamap2-2.0-1.0-v2.dat', 'hhar-2.0-0.5.dat', 
                        'opportunity-1.6-0.0.dat', 'opportunity-2.0-0.0.dat',
                        'Shoaib_collossl.dat'], help='name of dataset file')
