...
import torch
from CLISA.dataloader import load_CLISA_data
...
parser.add_argument('-lr', '--learning-rate', default=0.0007, type=float, metavar='LR', help='initial learning rate', dest='lr')
...
def main():
    ...
    train_loader = load_CLISA_data(version=args.version, datasets_name=args.name)
