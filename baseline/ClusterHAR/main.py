...
def main():
    ...
    dataset = ClusterCLDataset(transfer=False, version=args.version, datasets_name=args.name)
    ...
    with torch.cuda.device(args.gpu_index):
        simclr = SimCLR_cluster(model=model, optimizer=optimizer, args=args)
